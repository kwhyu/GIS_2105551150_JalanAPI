...
<section class="page-section" id="map-form-section">
            ...
            <div class="col-md-4 form-container">
                ...
                <div class="p-4">
                    ...
                    <form id="ruasForm" action="{{ route('submitRuasJalan') }}" method="POST">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#confirmSimpanModal">Submit</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="confirmSimpanModal" tabindex="-1" role="dialog" aria-labelledby="confirmSimpanModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <img src="{{ asset('assets/img/centang.png') }}" alt="Centang Icon" style="width: 70px; height: 70px;">
                </div>
